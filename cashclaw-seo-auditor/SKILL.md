...
- This skill is compatible with Claude Code, Claude.ai, and Claude Platform.
- To use: upload the ZIP file in Claude.ai → Customize → Skills.
- Requires: web browsing capability, markdown output.
- Pricing: Free community edition. Pro version with automated crawling available at cashclawai.com
